...
},{"buffer":5,"oMfpAn":9}],60:[function(require,module,exports){
(function(){!function(window){function has(name){if(has[name]!==undef)return has[name];var isSupported;if("bug-string-char-index"==name)isSupported="a"!="a"[0];else if("json"==name)isSupported=has("json-stringify")&&has("json-parse");else{var value,serialized='{"a":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}';if("json-stringify"==name){var stringify=JSON3.stringify,stringifySupported="function"==typeof stringify&&isExtended;if(stringifySupported){(value=function(){return 1}).toJSON=value;try{stringifySupported="0"===stringify(0)&&"0"===stringify(new Number)&&'""'==stringify(new String)&&stringify(getClass)===undef&&stringify(undef)===undef&&stringify()===undef&&"1"===stringify(value)&&"[1]"==stringify([value])&&"[null]"==stringify([undef])&&"null"==stringify(null)&&"[null,null,null]"==stringify([undef,getClass,null])&&stringify({a:[value,!0,!1,null,"\x00\b\n\f\r	"]})==serialized&&"1"===stringify(null,value)&&"[\n 1,\n 2\n]"==stringify([1,2],null,1)&&'"-271821-04-20T00:00:00.000Z"'==stringify(new Date(-864e13))&&'"+275760-09-13T00:00:00.000Z"'==stringify(new Date(864e13))&&'"-000001-01-01T00:00:00.000Z"'==stringify(new Date(-621987552e5))&&'"1969-12-31T23:59:59.999Z"'==stringify(new Date(-1))}catch(exception){stringifySupported=!1}}isSupported=stringifySupported}if("json-parse"==name){var parse=JSON3.parse;if("function"==typeof parse)try{if(0===parse("0")&&!parse(!1)){value=parse(serialized);var parseSupported=5==value.a.length&&1===value.a[0];if(parseSupported){try{parseSupported=!parse('"	"')}catch(exception){}if(parseSupported)try{parseSupported=1!==parse("01")}catch(exception){}if(parseSupported)try{parseSupported=1!==parse("1.")}catch(exception){}}}}catch(exception){parseSupported=!1}isSupported=parseSupported}}return has[name]=!!isSupported}var isProperty,forEach,undef,getClass={}.toString,isLoader="function"==typeof define&&define.amd,nativeJSON="object"==typeof JSON&&JSON,JSON3="object"==typeof exports&&exports&&!exports.nodeType&&exports;JSON3&&nativeJSON?(JSON3.stringify=nativeJSON.stringify,JSON3.parse=nativeJSON.parse):JSON3=window.JSON=nativeJSON||{};var isExtended=new Date(-0xc782b5b800cec);try{isExtended=-109252==isExtended.getUTCFullYear()&&0===isExtended.getUTCMonth()&&1===isExtended.getUTCDate()&&10==isExtended.getUTCHours()&&37==isExtended.getUTCMinutes()&&6==isExtended.getUTCSeconds()&&708==isExtended.getUTCMilliseconds()}catch(exception){}if(!has("json")){var functionClass="[object Function]",dateClass="[object Date]",numberClass="[object Number]",stringClass="[object String]",arrayClass="[object Array]",booleanClass="[object Boolean]",charIndexBuggy=has("bug-string-char-index");if(!isExtended)var floor=Math.floor,Months=[0,31,59,90,120,151,181,212,243,273,304,334],getDay=function(year,month){return Months[month]+365*(year-1970)+floor((year-1969+(month=+(month>1)))/4)-floor((year-1901+month)/100)+floor((year-1601+month)/400)};(isProperty={}.hasOwnProperty)||(isProperty=function(property){var constructor,members={};return(members.__proto__=null,members.__proto__={toString:1},members).toString!=getClass?isProperty=function(property){var original=this.__proto__,result=property in(this.__proto__=null,this);return this.__proto__=original,result}:(constructor=members.constructor,isProperty=function(property){var parent=(this.constructor||constructor).prototype;return property in this&&!(property in parent&&this[property]===parent[property])}),members=null,isProperty.call(this,property)});var PrimitiveTypes={"boolean":1,number:1,string:1,undefined:1},isHostType=function(object,property){var type=typeof object[property];return"object"==type?!!object[property]:!PrimitiveTypes[type]};if(forEach=function(object,callback){var Properties,members,property,size=0;(Properties=function(){this.valueOf=0}).prototype.valueOf=0,members=new Properties;for(property in members)isProperty.call(members,property)&&size++;return Properties=members=null,size?forEach=2==size?function(object,callback){var property,members={},isFunction=getClass.call(object)==functionClass;for(property in object)isFunction&&"prototype"==property||isProperty.call(members,property)||!(members[property]=1)||!isProperty.call(object,property)||callback(property)}:function(object,callback){var property,isConstructor,isFunction=getClass.call(object)==functionClass;for(property in object)isFunction&&"prototype"==property||!isProperty.call(object,property)||(isConstructor="constructor"===property)||callback(property);(isConstructor||isProperty.call(object,property="constructor"))&&callback(property)}:(members=["valueOf","toString","toLocaleString","propertyIsEnumerable","isPrototypeOf","hasOwnProperty","constructor"],forEach=function(object,callback){var property,length,isFunction=getClass.call(object)==functionClass,hasProperty=!isFunction&&"function"!=typeof object.constructor&&isHostType(object,"hasOwnProperty")?object.hasOwnProperty:isProperty;for(property in object)isFunction&&"prototype"==property||!hasProperty.call(object,property)||callback(property);for(length=members.length;property=members[--length];hasProperty.call(object,property)&&callback(property));}),forEach(object,callback)},!has("json-stringify")){var Escapes={92:"\\\\",34:'\\"',8:"\\b",12:"\\f",10:"\\n",13:"\\r",9:"\\t"},leadingZeroes="000000",toPaddedString=function(width,value){return(leadingZeroes+(value||0)).slice(-width)},unicodePrefix="\\u00",quote=function(value){var symbols,result='"',index=0,length=value.length,isLarge=length>10&&charIndexBuggy;for(isLarge&&(symbols=value.split(""));length>index;index++){var charCode=value.charCodeAt(index);switch(charCode){case 8:case 9:case 10:case 12:case 13:case 34:case 92:result+=Escapes[charCode];break;default:if(32>charCode){result+=unicodePrefix+toPaddedString(2,charCode.toString(16));break}result+=isLarge?symbols[index]:charIndexBuggy?value.charAt(index):value[index]}}return result+'"'},serialize=function(property,object,callback,properties,whitespace,indentation,stack){var value,className,year,month,date,time,hours,minutes,seconds,milliseconds,results,element,index,length,prefix,result;try{value=object[property]}catch(exception){}if("object"==typeof value&&value)if(className=getClass.call(value),className!=dateClass||isProperty.call(value,"toJSON"))"function"==typeof value.toJSON&&(className!=numberClass&&className!=stringClass&&className!=arrayClass||isProperty.call(value,"toJSON"))&&(value=value.toJSON(property));else if(value>-1/0&&1/0>value){if(getDay){for(date=floor(value/864e5),year=floor(date/365.2425)+1970-1;getDay(year+1,0)<=date;year++);for(month=floor((date-getDay(year,0))/30.42);getDay(year,month+1)<=date;month++);date=1+date-getDay(year,month),time=(value%864e5+864e5)%864e5,hours=floor(time/36e5)%24,minutes=floor(time/6e4)%60,seconds=floor(time/1e3)%60,milliseconds=time%1e3}else year=value.getUTCFullYear(),month=value.getUTCMonth(),date=value.getUTCDate(),hours=value.getUTCHours(),minutes=value.getUTCMinutes(),seconds=value.getUTCSeconds(),milliseconds=value.getUTCMilliseconds();value=(0>=year||year>=1e4?(0>year?"-":"+")+toPaddedString(6,0>year?-year:year):toPaddedString(4,year))+"-"+toPaddedString(2,month+1)+"-"+toPaddedString(2,date)+"T"+toPaddedString(2,hours)+":"+toPaddedString(2,minutes)+":"+toPaddedString(2,seconds)+"."+toPaddedString(3,milliseconds)+"Z"}else value=null;if(callback&&(value=callback.call(object,property,value)),null===value)return"null";if(className=getClass.call(value),className==booleanClass)return""+value;if(className==numberClass)return value>-1/0&&1/0>value?""+value:"null";if(className==stringClass)return quote(""+value);if("object"==typeof value){for(length=stack.length;length--;)if(stack[length]===value)throw TypeError();if(stack.push(value),results=[],prefix=indentation,indentation+=whitespace,className==arrayClass){for(index=0,length=value.length;length>index;index++)element=serialize(index,value,callback,properties,whitespace,indentation,stack),results.push(element===undef?"null":element);result=results.length?whitespace?"[\n"+indentation+results.join(",\n"+indentation)+"\n"+prefix+"]":"["+results.join(",")+"]":"[]"}else forEach(properties||value,function(property){var element=serialize(property,value,callback,properties,whitespace,indentation,stack);element!==undef&&results.push(quote(property)+":"+(whitespace?" ":"")+element)}),result=results.length?whitespace?"{\n"+indentation+results.join(",\n"+indentation)+"\n"+prefix+"}":"{"+results.join(",")+"}":"{}";return stack.pop(),result}};JSON3.stringify=function(source,filter,width){var whitespace,callback,properties,className;if("function"==typeof filter||"object"==typeof filter&&filter)if((className=getClass.call(filter))==functionClass)callback=filter;else if(className==arrayClass){properties={};for(var value,index=0,length=filter.length;length>index;value=filter[index++],className=getClass.call(value),(className==stringClass||className==numberClass)&&(properties[value]=1));}if(width)if((className=getClass.call(width))==numberClass){if((width-=width%1)>0)for(whitespace="",width>10&&(width=10);whitespace.length<width;whitespace+=" ");}else className==stringClass&&(whitespace=width.length<=10?width:width.slice(0,10));return serialize("",(value={},value[""]=source,value),callback,properties,whitespace,"",[])}}if(!has("json-parse")){var Index,Source,fromCharCode=String.fromCharCode,Unescapes={92:"\\",34:'"',47:"/",98:"\b",116:"	",110:"\n",102:"\f",114:"\r"},abort=function(){throw Index=Source=null,SyntaxError()},lex=function(){for(var value,begin,position,isSigned,charCode,source=Source,length=source.length;length>Index;)switch(charCode=source.charCodeAt(Index)){case 9:case 10:case 13:case 32:Index++;break;case 123:case 125:case 91:case 93:case 58:case 44:return value=charIndexBuggy?source.charAt(Index):source[Index],Index++,value;case 34:for(value="@",Index++;length>Index;)if(charCode=source.charCodeAt(Index),32>charCode)abort();else if(92==charCode)switch(charCode=source.charCodeAt(++Index)){case 92:case 34:case 47:case 98:case 116:case 110:case 102:case 114:value+=Unescapes[charCode],Index++;break;case 117:for(begin=++Index,position=Index+4;position>Index;Index++)charCode=source.charCodeAt(Index),charCode>=48&&57>=charCode||charCode>=97&&102>=charCode||charCode>=65&&70>=charCode||abort();value+=fromCharCode("0x"+source.slice(begin,Index));break;default:abort()}else{if(34==charCode)break;for(charCode=source.charCodeAt(Index),begin=Index;charCode>=32&&92!=charCode&&34!=charCode;)charCode=source.charCodeAt(++Index);value+=source.slice(begin,Index)}if(34==source.charCodeAt(Index))return Index++,value;abort();default:if(begin=Index,45==charCode&&(isSigned=!0,charCode=source.charCodeAt(++Index)),charCode>=48&&57>=charCode){for(48==charCode&&(charCode=source.charCodeAt(Index+1),charCode>=48&&57>=charCode)&&abort(),isSigned=!1;length>Index&&(charCode=source.charCodeAt(Index),charCode>=48&&57>=charCode);Index++);if(46==source.charCodeAt(Index)){for(position=++Index;length>position&&(charCode=source.charCodeAt(position),charCode>=48&&57>=charCode);position++);position==Index&&abort(),Index=position}if(charCode=source.charCodeAt(Index),101==charCode||69==charCode){for(charCode=source.charCodeAt(++Index),(43==charCode||45==charCode)&&Index++,position=Index;length>position&&(charCode=source.charCodeAt(position),charCode>=48&&57>=charCode);position++);position==Index&&abort(),Index=position}return+source.slice(begin,Index)}if(isSigned&&abort(),"true"==source.slice(Index,Index+4))return Index+=4,!0;if("false"==source.slice(Index,Index+5))return Index+=5,!1;if("null"==source.slice(Index,Index+4))return Index+=4,null;abort()}return"$"},get=function(value){var results,hasMembers;if("$"==value&&abort(),"string"==typeof value){if("@"==(charIndexBuggy?value.charAt(0):value[0]))return value.slice(1);if("["==value){for(results=[];value=lex(),"]"!=value;hasMembers||(hasMembers=!0))hasMembers&&(","==value?(value=lex(),"]"==value&&abort()):abort()),","==value&&abort(),results.push(get(value));return results}if("{"==value){for(results={};value=lex(),"}"!=value;hasMembers||(hasMembers=!0))hasMembers&&(","==value?(value=lex(),"}"==value&&abort()):abort()),(","==value||"string"!=typeof value||"@"!=(charIndexBuggy?value.charAt(0):value[0])||":"!=lex())&&abort(),results[value.slice(1)]=get(lex());return results}abort()}return value},update=function(source,property,callback){var element=walk(source,property,callback);element===undef?delete source[property]:source[property]=element},walk=function(source,property,callback){var length,value=source[property];if("object"==typeof value&&value)if(getClass.call(value)==arrayClass)for(length=value.length;length--;)update(value,length,callback);else forEach(value,function(property){update(value,property,callback)});return callback.call(source,property,value)};JSON3.parse=function(source,callback){var result,value;return Index=0,Source=""+source,result=get(lex()),"$"!=lex()&&abort(),Index=Source=null,callback&&getClass.call(callback)==functionClass?walk((value={},value[""]=result,value),"",callback):result}}}isLoader&&define(function(){return JSON3})}(this)}).call(this,require("oMfpAn"),"undefined"!=typeof self?self:"undefined"!=typeof window?window:{},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/../../node_modules/socket.io-client/node_modules/socket.io-parser/node_modules/json3/lib/json3.js","/../../node_modules/socket.io-client/node_modules/socket.io-parser/node_modules/json3/lib");
},{"buffer":5,"oMfpAn":9}],61:[function(require,module,exports){
(function(){function toArray(list,index){var array=[];index=index||0;for(var i=index||0;i<list.length;i++)array[i-index]=list[i];return array}module.exports=toArray}).call(this,require("oMfpAn"),"undefined"!=typeof self?self:"undefined"!=typeof window?window:{},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/../../node_modules/socket.io-client/node_modules/to-array/index.js","/../../node_modules/socket.io-client/node_modules/to-array");
},{"buffer":5,"oMfpAn":9}],62:[function(require,module,exports){
(function(process,global){function getURLParameter(name){return decodeURIComponent((new RegExp("[?|&]"+name+"=([^&;]+?)(&|#|;|$)").exec(location.search)||[,""])[1].replace(/\+/g,"%20"))||null}function rateDelayUpdate(lamp,amount,$interval){lamp.rateDelayActive=!0,$interval(function(){--lamp.rate_delay,lamp.rate_delay<=0&&(lamp.rateDelayActive=!1)},1e3,amount)}var io=require("socket.io-client");global.window.io=io;var angular=require("angular");require("angular-socket-io"),require("angular-animate"),require("./libs/angular-busy.min.js"),require("./libs/angular-material.js");var konami=require("konami-js");!function(){"use strict";var app=angular.module("dorfmap",["ngMaterial","cgBusy","btford.socket-io"]);app.factory("socket",["socketFactory",function(socketFactory){return socketFactory({})}]),app.controller("MapController",["$http","$timeout","$scope","$materialDialog",function($http,$timeout,$scope,$materialDialog){new konami(function(){window.location="/static/images/madeby_derf0_and_marudor.jpg",$materialDialog({template:"<img src='/static/images/madeby_derf0_and_marudor.jpg'/>"})});var map=this;map.layer=getURLParameter("layer")||"control",$http.get("/ajax/menu.json").success(function(data){map.menu=data,map.menuEntries={};var max=0;data.forEach(function(d,index){map.menuEntries[d.name]=index,d.entries.length>max&&(max=d.entries.length),"shortcuts"===d.name&&(d.function=function(action,hide){$http.post("/action",{action:"shortcut",shortcut:action}).success(function(){var timeout=0;-1===action.indexOf("amps")&&(timeout=500),"shutdown"===action?$scope.$emit("shutdown"):$timeout(function(){$scope.$emit("update")},timeout)}),hide()}),"presets"===d.name&&(d.function=function(action,hide){$http.post("/action",{action:"preset",preset:action}).success(function(){$scope.$emit("update")}),hide()}),"layers"===d.name&&(d.function=function(layer,hide){map.layer=layer,hide()})}),data.height=24*max,map.menu.dialog=function(key){$materialDialog({templateUrl:"/static/templates/dropdownmenu-template.html",controller:["$scope","$hideDialog",function($scope,$hideDialog){$scope.dropdownData=data,$scope.selectedIndex=map.menuEntries[key],$scope.hide=$hideDialog}]})},$scope.$emit("update")})}]),app.controller("OverviewController",["$http","$scope","$sce","$interval","$materialDialog","$q","$timeout","socket",function($http,$scope,$sce,$interval,$materialDialog,$q,$timeout,socket){var overview=this;overview.lamps={},socket.on("toggle",function(data){overview.lamps[data.name].update(data,!0)}),this.update=function(){var httpGet=$http.get("/list/all.json").success(function(data){Object.keys(data).forEach(function(key){overview.lamps[key]?overview.lamps[key].update(data[key],!1):("string"==typeof data[key].status_text&&(data[key].status_text=$sce.trustAsHtml(data[key].status_text)),overview.lamps[key]=data[key],overview.lamps[key].rateDelayActive=!1,overview.lamps[key].blocked=!1,overview.lamps[key].canAccess=function(){return this.is_writable&&this.rate_delay<=0&&!this.blocked},overview.lamps[key].update=function(data,complete){data&&(this.status=data.status,this.type=data.type,0===data.status&&(this.rate_delay=data.rate_delay),"string"==typeof data.status_text&&(this.status_text=$sce.trustAsHtml(data.status_text),data.infoarea&&(overview.lamps.infoarea.status_text=$sce.trustAsHtml(data.infoarea)))),complete&&(this.status=this.status?parseInt(this.status):0,0===this.status&&!this.rateDelayActive&&this.rate_delay>0&&rateDelayUpdate(this,this.rate_delay,$interval))},overview.lamps[key].imageClass=function(){return this.canAccess()?"lampimage":""},overview.lamps[key].isAuto=function(){return"light_au"===this.type},overview.lamps[key].image=function(){if("dorfdoor"==key)return"/static/images/dorfdoor.png";var statusName=1===this.status?"on":"off";if("hackcenter_blau"===key)return"/static/images/hackcenter_blau_"+statusName+".png";if(this.isAuto()){var autoPrefix=0===this.auto?"no":"";return-1===this.status?"/static/images/light_"+autoPrefix+"auto.png":"/static/images/light_"+statusName+"_"+autoPrefix+"auto.png"}return-1===this.status?"/static/images/"+this.type+".png":"/static/images/"+this.type+"_"+statusName+".png"},overview.lamps[key].style=function(dup){var style={},l=this;return dup&&(l=dup),style.left=l.x1+"px",style.top=l.y1+"px",32!=l.x2&&(style.width=l.x2+"px"),32!=l.y2&&(style.height=l.y2+"px"),style},overview.lamps[key].statusClass=function(){return"infoarea"!=this.type&&"rtext"!=this.type?"popup":void 0},overview.lamps[key].class=function(){return"dorfdoor"===key?0===this.status?"closed":"open":"rtext"===this.type?"rtext":""},overview.lamps[key].toggle=function($event){if(this.canAccess()){if("blinkenlight"==this.type)return void $materialDialog({templateUrl:"/static/templates/blinkencontrol-template.html",targetEvent:$event,controller:function($scope,$hideDialog,$http){$scope.lamp=overview.lamps[key],$scope.loadingPromise=$http.get("ajax/blinkencontrol?device="+key).success(function(data){$scope.animations=data.presets,data.active&&($scope.animations.selected=data.active.raw_string),socket.on("blinkencontrol",function(data){$scope.animations.selected=data.raw_string,$scope.lamp.status=data.status})}),$scope.close=function(){$hideDialog()},$scope.save=function(){$http.post("/ajax/blinkencontrol",{device:$scope.lamp.name,raw_string:$scope.animations.selected}).success(function(data){$scope.lamp.status=data.status,socket.emit("blinkencontrol",{device:$scope.lamp.name,raw_string:$scope.animations.selected,status:data.status})}),$scope.close()}}});if("charwrite"==this.type)return void $materialDialog({templateUrl:"/static/templates/charwrite-template.html",targetEvent:$event,controller:["$scope","$hideDialog","$http",function($scope,$hideDialog,$http){$scope.lamp=overview.lamps[key],$scope.loadingPromise=$http.get("/ajax/charwrite").success(function(data){$scope.modes=data,$scope.radioGroup="custom",-1!=$scope.modes.map(function(m){return m.name}).indexOf($scope.lamp.charwrite_text)&&($scope.radioGroup=$scope.lamp.charwrite_text)}),$scope.customModes=["date","clock","hosts","power"],$scope.close=function(){$scope.lamp.newText="",$hideDialog()},$scope.save=function(){"custom"===$scope.radioGroup&&($scope.radioGroup=$scope.lamp.newText),$http.post("/ajax/charwrite",{device:$scope.lamp.name,text:$scope.radioGroup}).success(function(){$scope.lamp.charwrite_text=$scope.radioGroup}),$scope.close()}}]});this.blocked=!0;var oldStatus=this.status;$http.post("/action",{action:"toggle",device:key}).success(function(data){if(data.name=key,data.type=overview.lamps[key].type,socket.emit("toggle",data),overview.lamps[key].status=parseInt(data.status),overview.lamps[key].auto=data.auto,overview.lamps.infoarea.status_text=$sce.trustAsHtml(data.infoarea),(oldStatus===overview.lamps[key].status||1==oldStatus&&0===overview.lamps[key].status)&&data.rate_delay>0)return overview.lamps[key].rate_delay=data.rate_delay,overview.lamps[key].blocked=!1,void(overview.lamps[key].rateDelayActive||rateDelayUpdate(overview.lamps[key],data.rate_delay,$interval));if(overview.lamps[key].isAuto()){var unsafeStatusText=overview.lamps[key].status_text.toString();1==overview.lamps[key].auto&&-1!=unsafeStatusText.indexOf("(deaktiviert)")?overview.lamps[key].status_text=$sce.trustAsHtml(unsafeStatusText.replace(" (deaktiviert)","")):0===overview.lamps[key].auto&&-1===unsafeStatusText.indexOf("(deaktiviert)")&&(overview.lamps[key].status_text=$sce.trustAsHtml(unsafeStatusText+" (deaktiviert)"))}overview.lamps[key].blocked=!1}),overview.lamps[key].isAuto()||(overview.lamps[key].status=!overview.lamps[key].status)}}),overview.lamps[key].update(null,!0)})});return $scope.map.loadingPromise||($scope.map.loadingPromise=httpGet),httpGet},$scope.$parent.$on("shutdown",function(){$scope.$parent.shutdownPromise=overview.update()}),$scope.$parent.$on("update",overview.update),this.filteredLamps=function(){return Object.keys(overview.lamps).filter(function(k){return overview.lamps[k].layer===$scope.map.layer}).map(function(key){return overview.lamps[key]})}}]),app.directive("lamp",function(){return{restrict:"E",templateUrl:"/static/templates/lamp-template.html"}})}()}).call(this,require("oMfpAn"),"undefined"!=typeof self?self:"undefined"!=typeof window?window:{},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/fake_cde8206f.js","/");
},{"./libs/angular-busy.min.js":63,"./libs/angular-material.js":64,"angular":3,"angular-animate":1,"angular-socket-io":2,"buffer":5,"konami-js":10,"oMfpAn":9,"socket.io-client":19}],63:[function(require,module,exports){
(function(){angular.module("cgBusy",[]),angular.module("cgBusy").factory("_cgBusyTrackerFactory",["$timeout","$q",function(a,b){return function(){var c={};c.promises=[],c.delayPromise=null,c.durationPromise=null,c.delayJustFinished=!1,c.reset=function(b){c.minDuration=b.minDuration,c.promises=[],angular.forEach(b.promises,function(a){a&&!a.$cgBusyFulfilled&&d(a)}),0!==c.promises.length&&(c.delayJustFinished=!1,b.delay&&(c.delayPromise=a(function(){c.delayPromise=null,c.delayJustFinished=!0},parseInt(b.delay,10))),b.minDuration&&(c.durationPromise=a(function(){c.durationPromise=null},parseInt(b.minDuration,10)+(b.delay?parseInt(b.delay,10):0))))},c.getThen=function(a){var c=a&&(a.then||a.$then||a.$promise&&a.$promise.then);return a.denodeify?b.when(a).then:c};var d=function(a){var b=c.getThen(a);if(!b)throw new Error("cgBusy expects a promise (or something that has a .promise or .$promise");-1===c.promises.indexOf(a)&&(c.promises.push(a),b(function(){a.$cgBusyFulfilled=!0,-1!==c.promises.indexOf(a)&&c.promises.splice(c.promises.indexOf(a),1)},function(){a.$cgBusyFulfilled=!0,-1!==c.promises.indexOf(a)&&c.promises.splice(c.promises.indexOf(a),1)}))};return c.active=function(){return c.delayPromise?!1:c.delayJustFinished?(c.delayJustFinished=!1,c.promises.length>0):c.durationPromise?!0:c.promises.length>0},c}}]),angular.module("cgBusy").value("cgBusyDefaults",{}),angular.module("cgBusy").directive("cgBusy",["$compile","$templateCache","cgBusyDefaults","$http","_cgBusyTrackerFactory",function(a,b,c,d,e){return{restrict:"A",link:function(f,g,h){var i=g.css("position");("static"===i||""===i||"undefined"==typeof i)&&g.css("position","relative");var j,k,l,m,n,o=e(),p={templateUrl:"angular-busy.html",delay:0,minDuration:0,backdrop:!0,message:"Please Wait..."};angular.extend(p,c),f.$watchCollection(h.cgBusy,function(c){if(c||(c={promise:null}),angular.isString(c))throw new Error("Invalid value for cg-busy.  cgBusy no longer accepts string ids to represent promises/trackers.");(angular.isArray(c)||o.getThen(c))&&(c={promise:c}),c=angular.extend(angular.copy(p),c),c.templateUrl||(c.templateUrl=p.templateUrl),angular.isArray(c.promise)||(c.promise=[c.promise]),m||(m=f.$new()),m.$message=c.message,angular.equals(o.promises,c.promise)||o.reset({promises:c.promise,delay:c.delay,minDuration:c.minDuration}),m.$cgBusyIsActive=function(){return o.active()},j&&l===c.templateUrl&&n===c.backdrop||(j&&j.remove(),k&&k.remove(),l=c.templateUrl,n=c.backdrop,d.get(l,{cache:b}).success(function(b){if(c.backdrop="undefined"==typeof c.backdrop?!0:c.backdrop,c.backdrop){var d='<div class="cg-busy cg-busy-backdrop cg-busy-backdrop-animation ng-hide" ng-show="$cgBusyIsActive()"></div>';k=a(d)(m),g.append(k)}var e='<div class="cg-busy cg-busy-animation ng-hide" ng-show="$cgBusyIsActive()">'+b+"</div>";j=a(e)(m),angular.element(j.children()[0]).css("position","absolute").css("top",0).css("left",0).css("right",0).css("bottom",0),g.append(j)}).error(function(a){throw new Error("Template specified for cgBusy ("+c.templateUrl+") could not be loaded. "+a)}))},!0)}}}]),angular.module("cgBusy").run(["$templateCache",function(a){"use strict";a.put("angular-busy.html",'<div class="cg-busy-default-wrapper">\n\n   <div class="cg-busy-default-sign">\n\n      <div class="cg-busy-default-spinner">\n         <div class="bar1"></div>\n         <div class="bar2"></div>\n         <div class="bar3"></div>\n         <div class="bar4"></div>\n         <div class="bar5"></div>\n         <div class="bar6"></div>\n         <div class="bar7"></div>\n         <div class="bar8"></div>\n         <div class="bar9"></div>\n         <div class="bar10"></div>\n         <div class="bar11"></div>\n         <div class="bar12"></div>\n      </div>\n\n      <div class="cg-busy-default-text">{{$message}}</div>\n\n   </div>\n\n</div>')}])}).call(this,require("oMfpAn"),"undefined"!=typeof self?self:"undefined"!=typeof window?window:{},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/libs/angular-busy.min.js","/libs");
},{"buffer":5,"oMfpAn":9}],64:[function(require,module,exports){
(function(){!function(){function MaterialEffects($animateSequence,$ripple,$rootElement,$position,$$rAF,$sniffer){function animateInkRipple(canvas,options){return new $ripple(canvas,options)}function popIn(element,parentElement,clickElement,done){function finished(ev){ev.target===element[0]&&(element.off(TRANSITIONEND_EVENT,finished),(done||angular.noop)())}parentElement.append(element);var startPos;if(clickElement){var clickPos=$position.offset(clickElement);startPos=translateString(clickPos.left-element[0].offsetWidth/2,clickPos.top-element[0].offsetHeight/2,0)+" scale(0.2)"}else startPos="translate3d(0,100%,0) scale(0.5)";element.css(TRANSFORM_PROPERTY,startPos).css("opacity",0),$$rAF(function(){$$rAF(function(){element.addClass("active").css(TRANSFORM_PROPERTY,"").css("opacity","").on(TRANSITIONEND_EVENT,finished)})})}function popOut(element,parentElement,done){function finished(ev){ev.target===element[0]&&(element.off(TRANSITIONEND_EVENT,finished),(done||angular.noop)())}var endPos=$position.positionElements(parentElement,element,"bottom-center");element.css({"-webkit-transform":translateString(endPos.left,endPos.top,0)+" scale(0.5)",opacity:0}),element.on(TRANSITIONEND_EVENT,finished)}function translateString(x,y,z){return"translate3d("+Math.floor(x)+"px,"+Math.floor(y)+"px,"+Math.floor(z)+"px)"}var isWebkit=(angular.isDefined($rootElement[0].animate)?"webAnimations":angular.isDefined(window.TweenMax||window.TweenLite)?"gsap":angular.isDefined(window.jQuery)?"jQuery":"default",/webkit/i.test($sniffer.vendorPrefix)),TRANSFORM_PROPERTY=isWebkit?"webkitTransform":"transform",TRANSITIONEND_EVENT="transitionend"+(isWebkit?" webkitTransitionEnd":"");return{inkRipple:animateInkRipple,popIn:popIn,popOut:popOut,TRANSFORM_PROPERTY:TRANSFORM_PROPERTY,TRANSITIONEND_EVENT:TRANSITIONEND_EVENT}}function MaterialRippleService($$rAF){function waveRadiusFn(touchDownMs,touchUpMs,anim){var waveMaxRadius=150,touchDown=touchDownMs/1e3,touchUp=touchUpMs/1e3,totalElapsed=touchDown+touchUp,ww=anim.width,hh=anim.height,waveRadius=1.1*Math.min(Math.sqrt(ww*ww+hh*hh),waveMaxRadius)+5,duration=1.1-.2*(waveRadius/waveMaxRadius),tt=totalElapsed/duration,size=waveRadius*(1-Math.pow(80,-tt));return Math.abs(size)}function waveOpacityFn(td,tu,anim){var touchUp=tu/1e3;return 0>=tu?anim.initialOpacity:Math.max(0,anim.initialOpacity-touchUp*anim.opacityDecayVelocity)}function waveOuterOpacityFn(td,tu,anim){var touchDown=td/1e3,outerOpacity=.3*touchDown,waveOpacity=waveOpacityFn(td,tu,anim);return Math.max(0,Math.min(outerOpacity,waveOpacity))}function waveDidFinish(wave,radius,anim){var waveMaxRadius=150,waveOpacity=waveOpacityFn(wave.tDown,wave.tUp,anim);return.01>waveOpacity&&radius>=Math.min(wave.maxRadius,waveMaxRadius)?!0:!1}function waveAtMaximum(wave,radius,anim){var waveMaxRadius=150,waveOpacity=waveOpacityFn(wave.tDown,wave.tUp,anim);return waveOpacity>=anim.initialOpacity&&radius>=Math.min(wave.maxRadius,waveMaxRadius)?!0:!1}function createWave(elem,width,height,startAt,recenter){var wave={startPosition:startAt,containerSize:Math.max(width,height),waveColor:window.getComputedStyle(elem).color,maxRadius:.75*distanceFromPointToFurthestCorner(startAt,{w:width,h:height}),isMouseDown:!0,mouseDownStart:now(),mouseUpStart:0,tDown:0,tUp:0};return recenter&&(wave.endPosition={x:width/2,y:height/2},wave.slideDistance=dist(wave.startPosition,wave.endPosition)),wave}function removeWave(wave,buffer){if(buffer&&buffer.length){var pos=buffer.indexOf(wave);buffer.splice(pos,1)}}function drawWave(wave,anim){function renderRipple(ctx,x,y,radius,innerColor,outerColor){outerColor&&(ctx.fillStyle=outerColor||"rgba(252, 252, 158, 1.0)",ctx.fillRect(0,0,ctx.canvas.width,ctx.canvas.height)),ctx.beginPath(),ctx.arc(x,y,radius,0,2*Math.PI,!1),ctx.fillStyle=innerColor||"rgba(252, 252, 158, 1.0)",ctx.fill(),ctx.closePath()}anim.waveColor=cssColorWithAlpha(wave.waveColor,waveOpacityFn(wave.tDown,wave.tUp,anim)),anim.backgroundFill&&(anim.backgroundFill=cssColorWithAlpha(wave.waveColor,waveOuterOpacityFn(wave.tDown,wave.tUp,anim)));var x=wave.startPosition.x,y=wave.startPosition.y;if(wave.endPosition){var translateFraction=Math.min(1,anim.radius/wave.containerSize*2/Math.sqrt(2));x+=translateFraction*(wave.endPosition.x-wave.startPosition.x),y+=translateFraction*(wave.endPosition.y-wave.startPosition.y)}renderRipple(anim.ctx,x,y,anim.radius,anim.waveColor,anim.backgroundFill)}function cssColorWithAlpha(cssColor,alpha){var parts=cssColor?cssColor.match(/^rgb\((\d+),\s*(\d+),\s*(\d+)\)$/):null;return"undefined"==typeof alpha&&(alpha=1),parts?"rgba("+parts[1]+", "+parts[2]+", "+parts[3]+", "+alpha+")":"rgba(255, 255, 255, "+alpha+")"}function dist(p1,p2){return Math.sqrt(Math.pow(p1.x-p2.x,2)+Math.pow(p1.y-p2.y,2))}function distanceFromPointToFurthestCorner(point,size){var tl_d=dist(point,{x:0,y:0}),tr_d=dist(point,{x:size.w,y:0}),bl_d=dist(point,{x:0,y:size.h}),br_d=dist(point,{x:size.w,y:size.h});return Math.max(tl_d,tr_d,bl_d,br_d)}var now=Date.now;window.performance&&performance.now&&(now=performance.now.bind(performance));var mixin=function(dst){return angular.forEach(arguments,function(obj){obj!==dst&&angular.forEach(obj,function(value,key){angular.isUndefined(dst[key])&&(dst[key]=value)})}),dst};return function(){function Ripple(canvas,options){return this.canvas=canvas,this.waves=[],this.cAF=void 0,angular.extend(this,mixin(options||{},{onComplete:angular.noop,initialOpacity:.6,opacityDecayVelocity:1.7,backgroundFill:!0,pixelDensity:1}))}return Ripple.prototype={createAt:function(startAt){var canvas=this.adjustBounds(this.canvas),width=canvas.width/this.pixelDensity,height=canvas.height/this.pixelDensity,recenter=this.canvas.classList.contains("recenteringTouch");startAt=startAt||{x:Math.round(width/2),y:Math.round(height/2)},this.waves.push(createWave(canvas,width,height,startAt,recenter)),this.cancelled=!1,this.animate()},draw:function(done){this.onComplete=done;for(var i=0;i<this.waves.length;i++){var wave=this.waves[i];if(wave.isMouseDown){wave.isMouseDown=!1,wave.mouseDownStart=0,wave.tUp=0,wave.mouseUpStart=now();break}}this.animate()},cancel:function(){return this.cancelled=!0,this},animate:function(active){angular.isUndefined(active)&&(active=!0),active===!1?angular.isDefined(this.cAF)&&(this._loop=null,this.cAF(),this.onComplete()):(this._loop||(this._loop=angular.bind(this,function(){var ctx=this.canvas.getContext("2d");ctx.scale(this.pixelDensity,this.pixelDensity),this.onAnimateFrame(ctx)})),this.cAF=$$rAF(this._loop))},onAnimateFrame:function(ctx){ctx.clearRect(0,0,ctx.canvas.width,ctx.canvas.height);for(var deleteTheseWaves=[],anim={initialOpacity:this.initialOpacity,opacityDecayVelocity:this.opacityDecayVelocity,height:ctx.canvas.height,width:ctx.canvas.width},i=0;i<this.waves.length;i++){var wave=this.waves[i];if(!this.cancelled){wave.mouseDownStart>0&&(wave.tDown=now()-wave.mouseDownStart),wave.mouseUpStart>0&&(wave.tUp=now()-wave.mouseUpStart);var radius=waveRadiusFn(wave.tDown,wave.tUp,anim),maximumWave=waveAtMaximum(wave,radius,anim),waveDissipated=waveDidFinish(wave,radius,anim),shouldKeepWave=!waveDissipated||!maximumWave;shouldKeepWave?drawWave(wave,angular.extend(anim,{radius:radius,backgroundFill:this.backgroundFill,ctx:ctx})):deleteTheseWaves.push(wave)}}this.cancelled&&(deleteTheseWaves=deleteTheseWaves.concat(this.waves));for(var i=0;i<deleteTheseWaves.length;++i)removeWave(deleteTheseWaves[i],this.waves);return this.waves.length?waveDissipated||maximumWave||this.animate():(ctx.clearRect(0,0,ctx.canvas.width,ctx.canvas.height),this.animate(!1)),this},adjustBounds:function(canvas){function sanitizePosition(style){var val=style.replace("px","");return val}var self=this,src=canvas.parentNode.getBoundingClientRect(),bounds={width:src.width,height:src.height};return angular.forEach("width height".split(" "),function(style){var value="auto"!=self[style]?self[style]:void 0;angular.isDefined(value)&&(bounds[style]=sanitizePosition(value),canvas.setAttribute(style,bounds[style]*self.pixelDensity+"px"))}),canvas.setAttribute("width",bounds.width*this.pixelDensity+"px"),canvas.setAttribute("height",bounds.height*this.pixelDensity+"px"),canvas}},Ripple}()}function MaterialButtonDirective(ngHrefDirectives,$expectAria){ngHrefDirectives[0];return{restrict:"E",transclude:!0,template:'<material-ripple start="center" initial-opacity="0.25" opacity-decay-velocity="0.75"></material-ripple>',compile:function(element,attr){var innerElement,href=attr.ngHref||attr.href;return href?(innerElement=angular.element("<a>"),innerElement.attr("ng-href",href),innerElement.attr("rel",attr.rel),innerElement.attr("target",attr.target)):(innerElement=angular.element("<button>"),innerElement.attr("type",attr.type),innerElement.attr("disabled",attr.ngDisabled||attr.disabled),innerElement.attr("form",attr.form)),innerElement.addClass("material-button-inner").append(element.contents()),element.append(innerElement),function(scope,element,attr,ctrl,transclude){transclude(scope,function(clone){element.append(clone)}),$expectAria(element,"aria-label",element.text())}}}}function materialCardDirective(){return{restrict:"E",link:function(){}}}function materialCheckboxDirective(inputDirectives,$expectAria){function postLink(scope,element,attr,ngModelCtrl){function keypressHandler(ev){ev.which===Constant.KEY_CODE.SPACE&&(ev.preventDefault(),listener(ev))}function listener(ev){Util.isDisabled(element)||scope.$apply(function(){checked=!checked,ngModelCtrl.$setViewValue(checked,ev&&ev.type),ngModelCtrl.$render()})}function render(){checked=ngModelCtrl.$viewValue,element.attr(Constant.ARIA.PROPERTY.CHECKED,checked),checked?element.addClass(CHECKED_CSS):element.removeClass(CHECKED_CSS)}var checked=!1;ngModelCtrl=ngModelCtrl||{$setViewValue:function(value){this.$viewValue=value},$parsers:[],$formatters:[]},attr.type="checkbox",attr.tabIndex=0,inputDirective.link(scope,{on:angular.noop,0:{}},attr,[ngModelCtrl]),element.attr(Constant.ARIA.PROPERTY.CHECKED,checked),element.attr("role",attr.type),element.attr("tabIndex",attr.tabIndex),element.on("click",listener),element.on("keypress",keypressHandler),ngModelCtrl.$render=render,$expectAria(element,Constant.ARIA.PROPERTY.LABEL,element.text())}var inputDirective=inputDirectives[0],CHECKED_CSS="material-checked";return{restrict:"E",transclude:!0,require:"?ngModel",template:'<div class="material-container"><material-ripple start="center" class="circle" material-checked="{{ checked }}" ></material-ripple><div class="material-icon"></div></div><div ng-transclude class="material-label"></div>',link:postLink}}function materialContentDirective(){return{restrict:"E",controller:angular.noop,link:function($scope,$element){$scope.$broadcast("$materialContentLoaded",$element)}}}function MaterialDialogDirective($$rAF){return{restrict:"E",link:function(scope,element){var node=element[0];$$rAF(function(){var content=node.querySelector(".dialog-content");content&&content.scrollHeight>content.clientHeight&&node.classList.add("dialog-content-overflow")})}}}function MaterialDialogService($timeout,$materialCompiler,$rootElement,$rootScope,$materialEffects,$animate){function showDialog(options){return options=angular.extend({appendTo:$rootElement,hasBackdrop:!0,clickOutsideToClose:!0,escapeToClose:!0,targetEvent:null,transformTemplate:function(template){return'<div class="material-dialog-container">'+template+"</div>"}},options||{}),options.appendTo=angular.element(options.appendTo),recentDialog&&recentDialog.then(function(destroyDialog){destroyDialog()}),recentDialog=$materialCompiler.compile(options).then(function(compileData){function destroyDialog(){destroyDialog.called||(destroyDialog.called=!0,backdrop&&$animate.leave(backdrop),options.escapeToClose&&$rootElement.off("keyup",onRootElementKeyup),options.clickOutsideToClose&&element.off("click",dialogClickOutside),$materialEffects.popOut(element,$rootElement,function(){element.remove(),scope.$destroy(),scope=null,element=null}))}function onRootElementKeyup(e){27==e.keyCode&&$timeout(destroyDialog)}function dialogClickOutside(e){e.target===element[0]&&$timeout(destroyDialog)}compileData.locals.$hideDialog=destroyDialog;var backdrop,scope=$rootScope.$new(!0),element=compileData.link(scope),popInTarget=options.targetEvent&&options.targetEvent.target&&angular.element(options.targetEvent.target);return options.hasBackdrop&&(backdrop=angular.element('<material-backdrop class="opaque ng-enter">'),$animate.enter(backdrop,options.appendTo,null)),$materialEffects.popIn(element,options.appendTo,popInTarget,function(){options.escapeToClose&&$rootElement.on("keyup",onRootElementKeyup),options.clickOutsideToClose&&element.on("click",dialogClickOutside)}),destroyDialog})}var recentDialog;return showDialog}function materialInputGroupDirective(){return{restrict:"CE",controller:["$element",function($element){this.setFocused=function(isFocused){$element.toggleClass("material-input-focused",!!isFocused)},this.setHasValue=function(hasValue){$element.toggleClass("material-input-has-value",!!hasValue)}}]}}function materialInputDirective(){return{restrict:"E",replace:!0,template:"<input>",require:["^?materialInputGroup","?ngModel"],link:function(scope,element,attr,ctrls){var inputGroupCtrl=ctrls[0],ngModelCtrl=ctrls[1];inputGroupCtrl&&(ngModelCtrl&&ngModelCtrl.$formatters.push(function(value){return inputGroupCtrl.setHasValue(!!value),value}),element.on("input",function(){inputGroupCtrl.setHasValue(!!element.val())}),element.on("focus",function(){inputGroupCtrl.setFocused(!0)}),element.on("blur",function(){inputGroupCtrl.setFocused(!1)}),scope.$on("$destroy",function(){inputGroupCtrl.setFocused(!1),inputGroupCtrl.setHasValue(!1)}))}}}function materialIconDirective(){return{restrict:"E",template:'<object class="material-icon"></object>',compile:function(element,attr){var object=angular.element(element[0].children[0]);angular.isDefined(attr.icon)&&object.attr("data",attr.icon)}}}function materialListDirective(){return{restrict:"E",link:function(){}}}function materialItemDirective(){return{restrict:"E",link:function(){}}}function materialRadioGroupDirective(){function link(scope,element,attr,ctrls){function keydownListener(ev){ev.which===Constant.KEY_CODE.LEFT_ARROW?(ev.preventDefault(),rgCtrl.selectPrevious(element)):ev.which===Constant.KEY_CODE.RIGHT_ARROW&&(ev.preventDefault(),rgCtrl.selectNext(element))}var rgCtrl=ctrls[0],ngModelCtrl=ctrls[1]||{$setViewValue:angular.noop};rgCtrl.init(ngModelCtrl),element.attr({role:Constant.ARIA.ROLE.RADIO_GROUP,tabIndex:"0"}).on("keydown",keydownListener)}function RadioGroupController(){this._radioButtonRenderFns=[]}function createRadioGroupControllerProto(){return{init:function(ngModelCtrl){this._ngModelCtrl=ngModelCtrl,this._ngModelCtrl.$render=angular.bind(this,this.render)},add:function(rbRender){this._radioButtonRenderFns.push(rbRender)},remove:function(rbRender){var index=this._radioButtonRenderFns.indexOf(rbRender);-1!==index&&this._radioButtonRenderFns.splice(index,1)},render:function(){this._radioButtonRenderFns.forEach(function(rbRender){rbRender()})},setViewValue:function(value,eventType){this._ngModelCtrl.$setViewValue(value,eventType),this.render()},getViewValue:function(){return this._ngModelCtrl.$viewValue},selectNext:function(element){return selectButton("next",element)},selectPrevious:function(element){return selectButton("previous",element)}}}function selectButton(direction,parent,loop){loop=angular.isUndefined(loop)?!0:!!loop;var buttons=iterator(findAllButtons(parent),loop);if(buttons.count()){var selected=findSelectedButton(parent),target=selected?"previous"==direction?buttons.previous(selected):buttons.next(selected):buttons.first();target&&angular.element(target).triggerHandler("click")}}function findAllButtons(element){return Array.prototype.slice.call(element[0].querySelectorAll("material-radio-button"))}function findSelectedButton(element){return element[0].querySelector("material-radio-button.material-checked")}return RadioGroupController.prototype=createRadioGroupControllerProto(),{restrict:"E",controller:RadioGroupController,require:["materialRadioGroup","?ngModel"],link:link}}function materialRadioButtonDirective($expectAria){function link(scope,element,attr,rgCtrl){function listener(ev){Util.isDisabled(element)||scope.$apply(function(){rgCtrl.setViewValue(attr.value,ev&&ev.type)})}function render(){var checked=rgCtrl.getViewValue()===attr.value;checked!==lastChecked&&(lastChecked=checked,element.attr(Constant.ARIA.PROPERTY.CHECKED,checked),checked?element.addClass(CHECKED_CSS):element.removeClass(CHECKED_CSS))}var lastChecked;rgCtrl.add(render),attr.$observe("value",render),element.on("click",listener).on("$destroy",function(){rgCtrl.remove(render)}).attr("role",Constant.ARIA.ROLE.RADIO),$expectAria(element,Constant.ARIA.PROPERTY.LABEL,element.text())}var CHECKED_CSS="material-checked";return{restrict:"E",require:"^materialRadioGroup",transclude:!0,template:'<div class="material-container"><material-ripple start="center" class="circle"></material-ripple><div class="material-off"></div><div class="material-on"></div></div><div ng-transclude class="material-label"></div>',link:link}}function materialSidenavController($scope,$element,$attrs,$timeout,$materialSidenav,$materialComponentRegistry){$materialComponentRegistry.register(this,$attrs.componentId),this.isOpen=function(){return!!$scope.isOpen},this.toggle=function(){$scope.isOpen=!$scope.isOpen},this.open=function(){$scope.isOpen=!0},this.close=function(){$scope.isOpen=!1}}function materialSidenavService($materialComponentRegistry){return function(handle){var instance=$materialComponentRegistry.get(handle);return instance||$materialComponentRegistry.notFoundError(handle),{isOpen:function(){return instance?instance.isOpen():void 0},toggle:function(){instance&&instance.toggle()},open:function(){instance&&instance.open()},close:function(){instance&&instance.close()}}}}function materialSidenavDirective($timeout){return{restrict:"E",scope:{},controller:"$materialSidenavController",link:function($scope,$element,$attr,sidenavCtrl){function openWatchAction(isOpen){$element.toggleClass("open",!!isOpen),isOpen?($element.parent().append(backdrop),backdrop.on("click",onBackdropClick)):backdrop.remove().off("click",onBackdropClick)}function onBackdropClick(){$timeout(function(){sidenavCtrl.close()})}var backdrop=angular.element('<material-backdrop class="material-sidenav-backdrop">');$scope.$watch("isOpen",openWatchAction)}}}function materialSliderDirective(){function rangeSettings(rangeEle){return{min:parseInt(""!==rangeEle.min?rangeEle.min:0,10),max:parseInt(""!==rangeEle.max?rangeEle.max:100,10),step:parseInt(""!==rangeEle.step?rangeEle.step:1,10)}}function link(scope,element){function render(){var settings=rangeSettings(rangeEle),adjustedValue=parseInt(ngModelCtrl.$viewValue,10)-settings.min,fillRatio=adjustedValue/(settings.max-settings.min);fillEle.style.width=100*fillRatio+"%",0>=fillRatio?element.addClass(MIN_VALUE_CSS):element.removeClass(MIN_VALUE_CSS)}var input=element.find("input"),ngModelCtrl=angular.element(input).controller("ngModel");if(input&&ngModelCtrl&&"range"===input[0].type){var rangeEle=input[0],trackEle=angular.element(element[0].querySelector(".material-track"));trackEle.append('<div class="material-fill"><div class="material-thumb"></div></div>');var fillEle=trackEle[0].querySelector(".material-fill");if(input.attr("step")){for(var settings=rangeSettings(rangeEle),tickCount=(settings.max-settings.min)/settings.step,tickMarkersEle=angular.element('<div class="material-tick-markers"></div>'),i=0;tickCount>i;i++)tickMarkersEle.append('<div class="material-tick"></div>');tickCount>0&&tickMarkersEle.addClass("visible"),trackEle.append(tickMarkersEle)}input.on("mousedown touchstart",function(){trackEle.addClass(ACTIVE_CSS)}),input.on("mouseup touchend",function(){trackEle.removeClass(ACTIVE_CSS)}),scope.$watch(function(){return ngModelCtrl.$viewValue},render)}}var MIN_VALUE_CSS="material-slider-min",ACTIVE_CSS="material-active";return{restrict:"E",scope:!0,transclude:!0,template:'<div class="material-track" ng-transclude></div>',link:link}}function TabsDirective($compile,$timeout,$materialEffects,$window,$$rAF){function compileTabsFn(){function findNode(selector,element){var container=element[0];return angular.element(container.querySelector(selector))}return{pre:function(scope,element,attrs,tabsController){scope.noink=angular.isDefined(attrs.noink),scope.nobar=angular.isDefined(attrs.nobar),scope.nostretch=angular.isDefined(attrs.nostretch),tabsController.noink=scope.noink,scope.$watch("$selIndex",function(index){tabsController.selectAt(index)});var elBar=findNode("material-ink-bar",element);elBar&&scope.nobar&&elBar.remove()},post:function(scope,element,attrs,tabsController,$transclude){function configureInk(){function refreshInkBar(skipAnimation){var tabElement=tabsController.selectedElement();if(tabElement&&tabElement.length&&angular.isDefined(inkBar)){var width=tabElement.prop("offsetWidth"),left=headerContainer.prop("offsetLeft")+tabElement.prop("offsetLeft")+(scope.headerPos||0);tabElement.hasClass("pagination-hide")&&(width=0);var styles={display:width>0?"block":"none",width:width+"px"};styles[$materialEffects.TRANSFORM_PROPERTY]="translate3d("+left+"px,0,0)",inkBar.toggleClass("animate",skipAnimation!==!0).css(styles)}}if(!scope.nobar){var inkBar=findNode("material-ink-bar",element),headerContainer=findNode(".tabs-header-items-container",element);return refreshInkBar(!0),$$rAF.debounce(refreshInkBar)}}function configurePagination(){function setHeaderPos(x){header.css($materialEffects.TRANSFORM_PROPERTY,"translate3d("+x+"px,0,0)"),scope.headerPos=x}function refreshPagination(){var tabsWidth=element.prop("offsetWidth")-PAGINATORS_WIDTH,tabs=header.children(),shouldPaginate=TAB_MIN_WIDTH*tabs.length>tabsWidth,isNewState=shouldPaginate!==pagination.active;pagination.active=shouldPaginate,shouldPaginate?(pagination.pagesCount=Math.ceil(TAB_MIN_WIDTH*tabs.length/tabsWidth),pagination.itemsPerPage=Math.max(1,Math.floor(tabs.length/pagination.pagesCount)),pagination.tabWidth=tabsWidth/pagination.itemsPerPage,header.css("width",pagination.tabWidth*tabs.length+"px"),setPage(isNewState?0:Math.min(pagination.page,pagination.pagesCount-1))):isNewState&&(setHeaderPos(0),header.css("width",""))}function setPage(page){var tabs=header.children();pagination.startIndex=page*pagination.itemsPerPage,pagination.endIndex=pagination.startIndex+pagination.itemsPerPage-1,pagination.hasPrev=page>0,pagination.hasNext=(page+1)*pagination.itemsPerPage<tabs.length,setHeaderPos(-page*pagination.itemsPerPage*pagination.tabWidth),(scope.$selIndex<pagination.startIndex||scope.$selIndex>pagination.endIndex)&&tabsController.selectAt(page>pagination.page?pagination.startIndex:pagination.endIndex,!0),pagination.page=page,updateInk()}function paginationWatchSelectedTab(selectedIndex){pagination.active&&(selectedIndex<pagination.startIndex||selectedIndex>pagination.endIndex)&&setPage(Math.floor(selectedIndex/pagination.itemsPerPage))}{var TAB_MIN_WIDTH=96,PAGINATORS_WIDTH=64,pagination=scope.pagination={next:function(){setPage(pagination.page+1)},prev:function(){setPage(pagination.page-1)}},header=findNode(".tabs-header-items",element);findNode(".tabs-header-items-container",element)}return scope.$watch("$selIndex",paginationWatchSelectedTab),refreshPagination}function alignTabButtons(){var align=attrs.tabsAlign||"top",container=findNode(".tabs-content",element);"bottom"==align&&element.prepend(container)}function selectDefaultTab(){var tabs=tabsController.$$tabs();tabs.length&&angular.isUndefined(scope.$selIndex)&&tabsController.select(tabs[0])}function transcludeHeaderItems(){$transclude(function(content){var header=findNode(".tabs-header-items",element),parent=angular.element(element[0]);angular.forEach(content,function(node){var intoHeader=isNodeType(node,"material-tab")||isNgRepeat(node);intoHeader?header.append(node):parent.prepend(node)})})}function transcludeContentItems(){function enableDisconnect(tab,content){if(content){var selectedFn=angular.bind(tab,tab.selected),deselectedFn=angular.bind(tab,tab.deselected);addDigestConnector(content),tab.deselected=function(){deselectedFn(),tab.$$postDigest(function(){content.$disconnect()})},tab.selected=function(){content.$reconnect(),selectedFn()},tab.active||tab.$$postDigest(function(){content.$disconnect()})}}function addToCache(cache,item){var scope=item.tab;cache[scope.$id]=item,cache.length=cache.length+1,scope.$on("$destroy",function(){angular.element(item.element).remove(),delete cache[scope.$id],cache.length=cache.length-1})}function getTabsHash(){return tabsController.$$hash}function extractContent(tab){var content=hasContent(tab)?tab.content:void 0,scope=content&&content.length?angular.element(content[0]).scope():null;return delete tab.content,{nodes:content,scope:scope}}function hasContent(tab){return tab.content&&tab.content.length}function notEmpty(view){var hasContent=!1;return angular.isDefined(view.nodes)&&angular.forEach(view.nodes,function(node){hasContent=hasContent||!isNodeEmpty(node)}),hasContent}function notInCache(tab){return!cache.contains(tab)}var cntr=findNode(".tabs-content",element),materialViewTmpl='<div class="material-view" ng-show="active"></div>';scope.$watch(getTabsHash,function(){function showTabContent(visible){cntr.toggleClass("ng-hide",!!visible)}var tabs=tabsController.$$tabs(notInCache),views=tabs.map(extractContent);views.some(notEmpty)?(angular.forEach(views,function(content,j){var tab=tabs[j++],materialView=$compile(materialViewTmpl)(tab);enableDisconnect(tab,content.scope),content.nodes&&angular.forEach(content.nodes,function(node){isNodeEmpty(node)||materialView.append(node)}),cntr.append(materialView),addToCache(cache,{tab:tab,element:materialView})}),showTabContent()):showTabContent(!1)})}var cache={length:0,contains:function(tab){return!angular.isUndefined(cache[tab.$id])}},updatePagination=configurePagination()||angular.noop,updateInk=configureInk()||angular.noop,update=$$rAF.debounce(function(){updatePagination(),updateInk()});angular.element($window).on("resize",update),scope.$on("$materialTabsChanged",update),transcludeHeaderItems(),transcludeContentItems(),alignTabButtons(),selectDefaultTab()}}}return{restrict:"E",replace:!1,transclude:"true",scope:{$selIndex:"=?selected"},compile:compileTabsFn,controller:["$scope","$attrs","$materialComponentRegistry","$timeout",TabsController],template:'<div class="tabs-header" ng-class="{\'tab-paginating\': pagination.active}">  <div class="tab-paginator prev" ng-if="pagination.active" ng-click="pagination.hasPrev && pagination.prev()" ng-class="{active: pagination.hasPrev}">  </div>  <div class="tabs-header-items-container">    <div class="tabs-header-items"></div>  </div>  <div class="tab-paginator next" ng-if="pagination.active" ng-click="pagination.hasNext && pagination.next()" ng-class="{active: pagination.hasNext}">  </div>  <material-ink-bar></material-ink-bar></div><div class="tabs-content ng-hide"></div>'}}function TabDirective($attrBind){function linkTab(scope,element,attrs,tabsController,$transclude){function configureWatchers(){var unwatch=scope.$watch("disabled",function(isDisabled){scope.active&&isDisabled&&tabsController.next(scope)});scope.$on("$destroy",function(){unwatch(),tabsController.remove(scope)})}function updateTabContent(scope){var tab=scope;$transclude(function(contents){tab.content=[],angular.forEach(contents,function(node){isNodeEmpty(node)||(isNodeType(node,"material-tab-label")?tab.label=node.childNodes:tab.content.push(node))})});var cntr=angular.element(element[0].querySelector("material-tab-label"));angular.isDefined(scope.label)?(cntr.append(scope.label),delete scope.label):(angular.forEach(scope.content,function(node){cntr.append(node)}),delete scope.content)}var defaults={active:!1,disabled:!1,deselected:noop,selected:noop};$attrBind(scope,attrs,{label:"@?",active:"=?",disabled:"=?ngDisabled",deselected:"&onDeselect",selected:"&onSelect"},defaults),configureWatchers(),updateTabContent(scope),element.on("click",function(){scope.disabled||scope.$apply(function(){tabsController.select(scope)})}),tabsController.add(scope,element)}var noop=angular.noop;return{restrict:"E",replace:!1,require:"^materialTabs",transclude:"true",scope:!0,link:linkTab,template:'<material-ripple initial-opacity="0.9" opacity-decay-velocity="0.89"> </material-ripple> <material-tab-label ng-class="{ disabled : disabled, active : active }"  ></material-tab-label>'}}function TabsController($scope,$attrs,$materialComponentRegistry,$timeout){function onTabsChanged(){onTabsChanged.queued||(onTabsChanged.queued=!0,$scope.$evalAsync(function(){$scope.$broadcast("$materialTabsChanged"),onTabsChanged.queued=!1}))}function findElementFor(tab){return angular.isUndefined(tab)&&(tab=selected),tab?elements[tab.$id]:void 0}function findTabs(filterBy){return list.items().filter(filterBy||angular.identity)}function updateHash(){self.$$hash=list.items().map(function(it){return it.$id}).join(",")}function selectTab(tab,noUpdate){if(tab!=selected){var activate=makeActivator(!0),deactivate=makeActivator(!1);return angular.forEach(list.items(),deactivate),selected=activate(tab.disabled?list.next(tab):tab),$scope.$selIndex=String(selected.$index||list.indexOf(selected)),noUpdate||onTabsChanged(),selected}}function selectTabAt(index,noUpdate){if(list.inRange(index)){var matches=list.findBy("$index",index),it=matches?matches[0]:null;it!=selected&&selectTab(it,noUpdate)}}function addTab(tab,element){if(angular.isUndefined(tab.$index)&&(tab.$index=list.count()),elements[tab.$id]=element,!list.contains(tab)){var pos=list.add(tab,tab.$index);$scope.$selIndex==pos||tab.active?selectTab(tab):onTabsChanged()}return updateHash(),tab.$index}function removeTab(tab){list.contains(tab)&&(selectTab(list.next(tab,isEnabled)),list.remove(tab),onTabsChanged(),$timeout(function(){delete elements[tab.$id]},300)),updateHash()}function selectNext(){return selectTab(list.next(selected,isEnabled))}function selectPrevious(){return selectTab(list.previous(selected,isEnabled))}function isEnabled(tab){return tab&&!tab.disabled}function makeActivator(active){return function(tab){return tab&&active!=tab.active?(tab.active=active,active?(selected=tab,tab.selected()):(selected==tab&&(selected=null),tab.deselected()),tab):null}}var list=iterator([],!0),componentID="tabs"+$scope.$id,elements={},selected=null,self=this;$materialComponentRegistry.register(self,$attrs.componentId||componentID),this.add=addTab,this.remove=removeTab,this.select=selectTab,this.selectAt=selectTabAt,this.next=selectNext,this.previous=selectPrevious,this.noink=!!$scope.noink,this.nobar=!!$scope.nobar,this.scope=$scope,this.$$tabs=findTabs,this.$$hash="",this.selectedElement=function(){return findElementFor(selected)}}function addDigestConnector(scope){var disconnect=function(){if(this.$root!==this){var parent=this.$parent;this.$$disconnected=!0,parent.$$childHead===this&&(parent.$$childHead=this.$$nextSibling),parent.$$childTail===this&&(parent.$$childTail=this.$$prevSibling),this.$$prevSibling&&(this.$$prevSibling.$$nextSibling=this.$$nextSibling),this.$$nextSibling&&(this.$$nextSibling.$$prevSibling=this.$$prevSibling),this.$$nextSibling=this.$$prevSibling=null}},reconnect=function(){if(this.$root!==this){var child=this;if(child.$$disconnected){var parent=child.$parent;child.$$disconnected=!1,child.$$prevSibling=parent.$$childTail,parent.$$childHead?(parent.$$childTail.$$nextSibling=child,parent.$$childTail=child):parent.$$childHead=parent.$$childTail=child}}};return scope.$disconnect=angular.bind(scope,disconnect),scope.$reconnect=angular.bind(scope,reconnect),scope}function iterator(items,reloop){function getItems(){return[].concat(_items)}function count(){return _items.length}function inRange(index){return _items.length&&index>-1&&index<_items.length}function hasNext(tab){return tab?inRange(indexOf(tab)+1):!1}function itemAt(index){return inRange(index)?_items[index]:null
}function findBy(key,val){function find(list,callback){var results=[];return angular.forEach(list,function(it,index){var val=callback.apply(null,[it,index,list]);val&&results.push(val)}),results.length?results:void 0}return find(_items,function(el){return el[key]==val?el:null})}function add(it,index){return angular.isDefined(index)||(index=_items.length),_items.splice(index,0,it),indexOf(it)}function remove(it){_items.splice(indexOf(it),1)}function indexOf(it){return _items.indexOf(it)}function contains(it){return it&&indexOf(it)>-1}function next(it,validate){if(contains(it)){var index=indexOf(it)+1,found=inRange(index)?_items[index]:reloop?first():null,skip=found&&validate&&!validate(found);return skip?next(found):found}return null}function previous(it,validate){if(contains(it)){var index=indexOf(it)-1,found=inRange(index)?_items[index]:reloop?last():null,skip=found&&validate&&!validate(found);return skip?previous(found):found}return null}function first(){return _items.length?_items[0]:null}function last(){return _items.length?_items[_items.length-1]:null}reloop=!!reloop;var _items=items||[];return{items:getItems,count:count,hasNext:hasNext,inRange:inRange,contains:contains,indexOf:indexOf,itemAt:itemAt,findBy:findBy,add:add,remove:remove,first:first,last:last,next:next,previous:previous}}function QpToastDirective(){return{restrict:"E"}}function QpToastService($timeout,$rootScope,$materialCompiler,$rootElement,$animate){function toastOpenClass(position){return"material-toast-open-"+(position.indexOf("top")>-1?"top":"bottom")}function showToast(options){return options=angular.extend({duration:3e3,swipeDisabled:!1,position:"bottom left"},options||{}),recentToast&&recentToast.then(function(destroy){destroy()}),recentToast=$materialCompiler.compile(options).then(function(compileData){function destroy(){toastParent.removeClass(toastParentClass),$timeout.cancel(delayTimeout),$animate.leave(element,function(){scope.$destroy()})}compileData.locals.$hideToast=destroy;var scope=$rootScope.$new(),element=compileData.link(scope),toastParentClass=toastOpenClass(options.position);element.addClass(options.position),toastParent.addClass(toastParentClass);var delayTimeout;return $animate.enter(element,toastParent,null,function(){options.duration&&(delayTimeout=$timeout(destroy,options.duration))}),destroy})}var recentToast,toastParent=$rootElement.find("body");return toastParent.length||(toastParent=$rootElement),showToast}function materialToolbarDirective($$rAF,$sniffer){var isWebkit=-1!==$sniffer.vendorPrefix.toLowerCase().indexOf("webkit"),TRANSFORM_PROPERTY=isWebkit?"webkitTransform":"transform";return{restrict:"E",controller:angular.noop,link:function(scope,element,attr){function setupScrollShrink(){function onMaterialContentLoad($event,contentEl){Util.elementIsSibling(element,contentEl)&&(contentElement&&contentElement.off("scroll",onScroll),contentEl.on("scroll",onContentScroll).css("position","relative"),contentElement=contentEl)}function onContentScroll(e){shrink(e.target.scrollTop),prevScrollTop=e.target.scrollTop}function shrink(scrollTop){y=Math.min(height,Math.max(0,y+scrollTop-prevScrollTop)),$$rAF(transform)}function transform(){var translate="translate3d(0,"+-y/HEIGHT_FACTOR+"px, 0)";element.css(TRANSFORM_PROPERTY,translate),contentElement.css("margin-top",-y/HEIGHT_FACTOR+"px")}var HEIGHT_FACTOR=2,height=element.prop("offsetHeight")*HEIGHT_FACTOR,y=0,prevScrollTop=0;scope.$on("$materialContentLoaded",onMaterialContentLoad);var contentElement}angular.isDefined(attr.scrollShrink)&&setupScrollShrink()}}}function ExpectAriaService(){return function(element,attrName,defaultValue){var node=element[0];if(!node.hasAttribute(attrName)){var hasDefault=angular.isDefined(defaultValue);hasDefault&&(defaultValue=String(defaultValue).trim(),element.attr(attrName,defaultValue))}}}function MaterialAttrBind($parse,$interpolate){var LOCAL_REGEXP=/^\s*([@=&])(\??)\s*(\w*)\s*$/;return function(scope,attrs,bindDefinition,bindDefaults){function bypassWithDefaults(attrName,scopeName,defaultVal){if(!angular.isDefined(attrs[attrName])){var hasDefault=bindDefaults&&bindDefaults.hasOwnProperty(scopeName);return scope[scopeName]=hasDefault?bindDefaults[scopeName]:defaultVal,!0}return!1}angular.forEach(bindDefinition||{},function(definition,scopeName){var parentGet,unWatchFn,match=definition.match(LOCAL_REGEXP)||[],attrName=match[3]||scopeName,mode=match[1];switch(mode){case"@":attrs.$observe(attrName,function(value){scope[scopeName]=value}),attrs.$$observers[attrName].$$scope=scope,bypassWithDefaults(attrName,scopeName)||(scope[scopeName]=$interpolate(attrs[attrName])(scope));break;case"=":bypassWithDefaults(attrName,scopeName)||(scope[scopeName]=""===attrs[attrName]?!0:scope.$eval(attrs[attrName]),unWatchFn=scope.$watch(attrs[attrName],function(value){scope[scopeName]=value}),scope.$on("$destroy",unWatchFn));break;case"&":if(!bypassWithDefaults(attrName,scopeName,angular.noop)){if(attrs[attrName]&&attrs[attrName].match(RegExp(scopeName+"(.*?)")))throw new Error('& expression binding "'+scopeName+'" looks like it will recursively call "'+attrs[attrName]+'" and cause a stack overflow! Please choose a different scopeName.');parentGet=$parse(attrs[attrName]),scope[scopeName]=function(locals){return parentGet(scope,locals)}}}})}}function materialCompilerService($q,$http,$injector,$compile,$controller,$templateCache){this.compile=function(options){var templateUrl=options.templateUrl,template=options.template||"",controller=options.controller,controllerAs=options.controllerAs,resolve=options.resolve||{},locals=options.locals||{},transformTemplate=options.transformTemplate||angular.identity;return angular.forEach(resolve,function(value,key){resolve[key]=angular.isString(value)?$injector.get(value):$injector.invoke(value)}),angular.extend(resolve,locals),resolve.$template=templateUrl?$http.get(templateUrl,{cache:$templateCache}).then(function(response){return response.data}):$q.when(template),$q.all(resolve).then(function(locals){var template=transformTemplate(locals.$template),element=angular.element("<div>").html(template).contents(),linkFn=$compile(element);return{locals:locals,element:element,link:function(scope){if(locals.$scope=scope,controller){var ctrl=$controller(controller,locals);element.data("$ngControllerController",ctrl),element.children().data("$ngControllerController",ctrl),controllerAs&&(scope[controllerAs]=ctrl)}return linkFn(scope)}}})}}function MaterialPositionService($document,$window){function getStyle(el,cssprop){return el.currentStyle?el.currentStyle[cssprop]:$window.getComputedStyle?$window.getComputedStyle(el)[cssprop]:el.style[cssprop]}function isStaticPositioned(element){return"static"===(getStyle(element,"position")||"static")}var parentOffsetEl=function(element){for(var docDomEl=$document[0],offsetParent=element.offsetParent||docDomEl;offsetParent&&offsetParent!==docDomEl&&isStaticPositioned(offsetParent);)offsetParent=offsetParent.offsetParent;return offsetParent||docDomEl};return{position:function(element){var elBCR=this.offset(element),offsetParentBCR={top:0,left:0},offsetParentEl=parentOffsetEl(element[0]);offsetParentEl!=$document[0]&&(offsetParentBCR=this.offset(angular.element(offsetParentEl)),offsetParentBCR.top+=offsetParentEl.clientTop-offsetParentEl.scrollTop,offsetParentBCR.left+=offsetParentEl.clientLeft-offsetParentEl.scrollLeft);var boundingClientRect=element[0].getBoundingClientRect();return{width:boundingClientRect.width||element.prop("offsetWidth"),height:boundingClientRect.height||element.prop("offsetHeight"),top:elBCR.top-offsetParentBCR.top,left:elBCR.left-offsetParentBCR.left}},offset:function(element){var boundingClientRect=element[0].getBoundingClientRect();return{width:boundingClientRect.width||element.prop("offsetWidth"),height:boundingClientRect.height||element.prop("offsetHeight"),top:boundingClientRect.top+($window.pageYOffset||$document[0].documentElement.scrollTop),left:boundingClientRect.left+($window.pageXOffset||$document[0].documentElement.scrollLeft)}},positionElements:function(hostEl,targetEl,positionStr,appendToBody){var hostElPos,targetElWidth,targetElHeight,targetElPos,positionStrParts=positionStr.split("-"),pos0=positionStrParts[0],pos1=positionStrParts[1]||"center";hostElPos=appendToBody?this.offset(hostEl):this.position(hostEl),targetElWidth=targetEl.prop("offsetWidth"),targetElHeight=targetEl.prop("offsetHeight");var shiftWidth={center:function(){return hostElPos.left+hostElPos.width/2-targetElWidth/2},left:function(){return hostElPos.left},right:function(){return hostElPos.left+hostElPos.width}},shiftHeight={center:function(){return hostElPos.top+hostElPos.height/2-targetElHeight/2},top:function(){return hostElPos.top},bottom:function(){return hostElPos.top+hostElPos.height}};switch(pos0){case"right":targetElPos={top:shiftHeight[pos1](),left:shiftWidth[pos0]()};break;case"left":targetElPos={top:shiftHeight[pos1](),left:hostElPos.left-targetElWidth};break;case"bottom":targetElPos={top:shiftHeight[pos0](),left:shiftWidth[pos1]()};break;default:targetElPos={top:shiftHeight[pos0](),left:shiftWidth[pos1]()}}return targetElPos}}}function materialComponentRegistry($log){var instances=[];return{notFoundError:function(handle){$log.error("No instance found for handle",handle)},getInstances:function(){return instances},get:function(handle){var i,j,instance;for(i=0,j=instances.length;j>i;i++)if(instance=instances[i],instance.$$materialHandle===handle)return instance;return null},register:function(instance,handle){return instance.$$materialHandle=handle,instances.push(instance),function(){var index=instances.indexOf(instance);-1!==index&&instances.splice(index,1)}}}}function MaterialThrottleService($timeout,$$q,$log){function buildInstance(phases,done,otherwise){function throttle(data,done){function cacheRquest(){pendingActions.push({data:data,done:done})}function invokeThrottleHandler(data,done){if(angular.isFunction(phases.throttle)){done=done||angular.noop;try{phases.throttle.apply(null,[data,function(response){done.apply(null,[response]),end()}])}catch(error){otherwise(error),end()}}else end()}switch(state!=STATE_THROTTLE&&cacheRquest(),state){case STATE_READY:start();break;case STATE_START:break;case STATE_THROTTLE:invokeThrottleHandler(data,done);break;case STATE_END:restart()}}function start(){function feedPendingActions(response){logResponse(response),state=STATE_THROTTLE,angular.forEach(pendingActions,function(it){throttle(it.data,function(response){logResponse(response),angular.isFunction(it.done)&&it.done(response)})}),pendingActions=[]}return gotoState.apply(null,[STATE_START,phases.start]).then(feedPendingActions,otherwise)}function end(){function finish(response){logResponse(response),state==STATE_END&&(state=STATE_READY,done())}return gotoState.apply(null,[STATE_END,phases.end]).then(finish,otherwise)}function restart(){try{angular.isFunction(cancel)||(cancel=angular.noop),cancel(),state=STATE_READY}finally{start()}}function gotoState(nextState,targetFn){var dfd=$$q.defer(),hasFn=angular.isFunction(targetFn),goNext=hasFn&&targetFn.length<1,fn=hasFn?targetFn:resolved;try{state=nextState,cancel=fn.apply(null,[goNext?resolved(dfd):hasFn?callbackToResolve(dfd):dfd])}catch(error){dfd.reject(error)}return dfd.promise}var pendingActions=[],cancel=angular.noop,state=STATE_READY;return $timeout(function(){start().then(function(){phases.throttle||end()})},0,!1),throttle}function callbackToResolve(dfd){return function(response){dfd.resolve.apply(null,[response])}}function resolved(dfd){return dfd=dfd||$$q.defer(),dfd.resolve.apply(null,arguments.length>1?[].slice.call(arguments,1):[]),dfd.promise}function logResponse(response){angular.isDefined(response)&&$log.debug(response)}var STATE_READY=0,STATE_START=1,STATE_THROTTLE=2,STATE_END=3;return function(config){return function(done,otherwise){return buildInstance(angular.extend({},config),done||angular.noop,otherwise||angular.noop)}}}angular.module("ngMaterial",["ng","ngAnimate","material.services.attrBind","material.services.compiler","material.services.position","material.services.registry","material.services.throttle","material.decorators","material.services.expectAria","material.components.button","material.components.card","material.components.checkbox","material.components.content","material.components.dialog","material.components.form","material.components.icon","material.components.list","material.components.radioButton","material.components.sidenav","material.components.slider","material.components.tabs","material.components.toast","material.components.toolbar","material.components.whiteframe"]),angular.module("ngAnimateSequence",["ngAnimate"]).factory("$$animateAll",function(){return function(arr,fn){function onChainDone(){++count==arr.length&&fn()}for(var count=0,i=0;i<arr.length;i++)arr[i](onChainDone)}}).provider("$$animateStyler",["$provide",function($provide){var register=this.register=function(name,factory){$provide.factory(name+"Styler",factory)};this.$get=["$injector",function($injector){return register("default",function(){return function(element,pre){return element.css(pre),function(post,done){element.css(post),done()}}}),function(name){return $injector.get(name+"Styler")}}]}]).factory("$animateRunner",["$$animateReflow","$animate","$$animateStyler","$$animateAll","$timeout",function($$animateReflow,$animate,$$animateStyler,$$animateAll,$timeout){return function(element,options,queue,duration,completeFn){function tick(initialTimeout){if(!paused){var step=queue[index++];if(!step||!$animate.enabled())return completeFn(),void(queue=null);if(angular.isString(step))return self[step].apply(self),void tick();var time=step[0],pre=step[1],post=step[2],fn=step[3];if(!initialTimeout&&1==index&&time>0&&1>=time&&duration>0)return index--,void $timeout(function(){tick(!0)},time*duration,!1);var animationDuration=time;if(duration>0&&1>=time){var nextEntry=queue[index],next=angular.isArray(nextEntry)?nextEntry[0]:1;1>=next&&(animationDuration=(next-time)*duration)}var postStyle=style(element,animationDuration,pre);return accumulatedStyles=angular.extend(accumulatedStyles,pre),accumulatedStyles=angular.extend(accumulatedStyles,post),$$animateReflow(function(){$$animateAll([function(done){postStyle(post||{},done)},function(done){cancelAnimation=fn(element,animationDuration,done)||angular.noop}],tick)}),self}}options=options||{};var self,node=element[0],index=0,paused=!1,cancelAnimation=angular.noop,styler=angular.isFunction(options.styler)?options.styler:$$animateStyler(angular.isString(options.styler)?options.styler:"default"),style=function(element,duration,cssStyles){cssStyles=cssStyles||{};var delay=cssStyles.delay;return delete cssStyles.delay,styler(element,cssStyles,duration,delay)};completeFn=completeFn||angular.noop;var startingClassName=node.className,accumulatedStyles={};return self={revertStyles:function(){return angular.forEach(accumulatedStyles,function(_,prop){node.style.removeProperty(prop)}),accumulatedStyles={},this},revertClasses:function(){return node.className=startingClassName,this},next:function(){return cancelAnimation(),tick()},redo:function(){return cancelAnimation(),index--,tick()},run:function(){return paused&&(paused=!1,cancelAnimation()),tick()},pause:function(){return paused=!0,cancelAnimation(),self},restart:function(){return cancelAnimation(),index=0,tick()}}}}]).factory("$animateSequence",["$animate","$animateRunner","$sniffer",function($animate,$animateRunner){return function(options){function addToChain(time,pre,post,fn){return queue.push([time||0,addSuffix(pre),addSuffix(post),fn]),queue=queue.sort(function(a,b){return a[0]>b[0]}),self}function addSuffix(target){var styles="top left right bottom x y width height border-width border-radius borderWidth borderRadiusmargin margin-top margin-bottom margin-left margin-right "+"padding padding-left padding-right padding-top padding-bottom".split(" ");return angular.forEach(target,function(val,key){var isPositional=styles.indexOf(key)>-1,hasPx=String(val).indexOf("px")>-1;isPositional&&!hasPx&&(target[key]=val+"px")}),target}var self,queue=[];return self={run:function(element,duration,completeFn){return $animateRunner(element,options,queue,duration,completeFn).next()},then:function(fn){return addToChain(0,null,null,function(element,duration,done){fn(element,done)})},animate:function(preOptions,postOptions,time){return 2!=arguments.length||angular.isObject(postOptions)?1==arguments.length?(postOptions=preOptions,preOptions={}):postOptions=postOptions||{}:(time=postOptions,postOptions=preOptions,preOptions={}),addToChain(time||postOptions.duration,preOptions,postOptions,function(_,duration,done){done()})},revertStyles:function(){return queue.push("revertStyles"),self},revertClasses:function(){return queue.push("revertClasses"),self},revertElement:function(){return this.revertStyles().revertClasses()},enter:function(parent,after,preOptions,postOptions,time){return addToChain(time,preOptions,postOptions,function(element,duration,done){return $animate.enter(element,parent,after,done)})},move:function(parent,after,preOptions,postOptions,time){return addToChain(time,preOptions,postOptions,function(element,duration,done){return $animate.move(element,parent,after,done)})},leave:function(preOptions,postOptions,time){return addToChain(time,preOptions,postOptions,function(element,duration,done){return $animate.leave(element,done)})},addClass:function(className,preOptions,postOptions,time){return addToChain(time,preOptions,postOptions,function(element,duration,done){return $animate.addClass(element,className,done)})},removeClass:function(className,preOptions,postOptions,time){return addToChain(time,preOptions,postOptions,function(element,duration,done){return $animate.removeClass(element,className,done)})},setClass:function(add,remove,preOptions,postOptions,time){return addToChain(time,preOptions,postOptions,function(element,duration,done){return $animate.setClass(element,add,remove,done)})}}}}]),angular.module("ngAnimateStylers",["ngAnimateSequence"]).config(["$$animateStylerProvider",function($$animateStylerProvider){function camelCaseStyles(styles){var newStyles={};return angular.forEach(styles,function(value,prop){prop=prop.toLowerCase().replace(/-(.)/g,function(match,group1){return group1.toUpperCase()}),newStyles[prop]=value}),newStyles}var isDefined=angular.isDefined;$$animateStylerProvider.register("jQuery",function(){return function(element,pre,duration,delay){return delay=delay||0,element.css(pre),function(post,done){element.animate(post,duration,null,done)}}}),$$animateStylerProvider.register("webAnimations",["$window","$sniffer",function($window,$sniffer){function computeStartingStyles(node,props){var computedStyles=$window.getComputedStyle(node),styles={};return angular.forEach(props,function(prop){var value=computedStyles[prop];!isDefined(value)&&webkit&&specialStyles.indexOf(prop)>=0&&(prop="webkit"+prop.charAt(0).toUpperCase()+prop.substr(1),value=computedStyles[prop]),isDefined(value)&&(styles[prop]=value)}),styles}function normalizeVendorPrefixes(styles){var newStyles={};return angular.forEach(styles,function(value,prop){webkit&&specialStyles.indexOf(prop)>=0&&(newStyles["webkit"+prop.charAt(0).toUpperCase()+prop.substr(1)]=value),newStyles[prop]=value}),newStyles}var specialStyles="transform,transition,animation".split(","),webkit="webkit"==$sniffer.vendorPrefix.toLowerCase();return function(element,pre,duration,delay){var node=element[0];if(!node.animate)throw new Error("WebAnimations (element.animate) is not defined for use within $$animationStylerProvider.");delay=delay||0,duration=duration||1e3;var iterations=1;return pre=camelCaseStyles(pre),function(post,done){var finalStyles=normalizeVendorPrefixes(post);post=camelCaseStyles(post);var missingProperties=[];angular.forEach(post,function(_,key){isDefined(pre[key])||missingProperties.push(key)}),missingProperties.length&&(pre=angular.extend(pre,computeStartingStyles(node,missingProperties)));var animation=node.animate([pre,post],{duration:duration,delay:delay,iterations:iterations});animation.onfinish=function(){element.css(finalStyles),done()}}}}]),$$animateStylerProvider.register("gsap",function(){return function(element,pre,duration,delay){var styler=TweenMax||TweenLite;if(!styler)throw new Error("GSAP TweenMax or TweenLite is not defined for use within $$animationStylerProvider.");return function(post,done){styler.fromTo(element,(duration||0)/1e3,pre||{},angular.extend(post,{onComplete:done,delay:(delay||0)/1e3}))}}})}]);var Util={isDisabled:function(element,limit){return Util.ancestorHasAttribute(element,"disabled",limit)},ancestorHasAttribute:function(element,attrName,limit){limit=limit||4;for(var current=element;limit--&&current.length;){if(current[0].hasAttribute&&current[0].hasAttribute(attrName))return!0;current=current.parent()}return!1},elementIsSibling:function(element,otherElement){return element.parent().length&&element.parent()[0]===otherElement.parent()[0]}},Constant={ARIA:{ROLE:{BUTTON:"button",CHECKBOX:"checkbox",RADIO:"radio",RADIO_GROUP:"radiogroup"},PROPERTY:{CHECKED:"aria-checked",HIDDEN:"aria-hidden",EXPANDED:"aria-expanded",LABEL:"aria-label"},STATE:{}},KEY_CODE:{SPACE:32,LEFT_ARROW:37,RIGHT_ARROW:39}};angular.module("material.animations",["ngAnimateStylers","ngAnimateSequence","material.services.position","material.services.throttle"]).service("$materialEffects",["$animateSequence","$ripple","$rootElement","$position","$$rAF","$sniffer",MaterialEffects]),angular.module("material.animations").service("$ripple",["$$rAF",MaterialRippleService]),function(){function attrNoDirective(){return function(){return{controller:angular.noop}}}angular.module("material.animations").directive({noink:attrNoDirective(),nobar:attrNoDirective(),nostretch:attrNoDirective()})}(),function(){function MaterialRippleDirective($materialEffects,$interpolate,$throttle){function compileWithCanvas(element,attrs){function calculateOptions(element,attrs){function getBounds(element){var node=element[0],styles=node.ownerDocument.defaultView.getComputedStyle(node,null)||{};return{left:"auto"!=styles.left&&styles.left?styles.left:"0px",top:"auto"!=styles.top&&styles.top?styles.top:"0px",width:getValue(styles,"width"),height:getValue(styles,"height")}}function getFloatValue(map,key,defaultVal){return angular.isDefined(map[key])?+map[key]:defaultVal}function getValue(map,key,defaultVal){var val=map[key];return angular.isDefined(val)&&""!==val?map[key]:defaultVal}return angular.extend(getBounds(element),{classList:attrs.class||"",forceToCenter:"center"==attrs.start,initialOpacity:getFloatValue(attrs,"initialOpacity"),opacityDecayVelocity:getFloatValue(attrs,"opacityDecayVelocity")})}var RIGHT_BUTTON=2,options=calculateOptions(element,attrs),tag='<canvas class="material-ink-ripple {{classList}}"style="top:{{top}}; left:{{left}}" ></canvas>';return element.replaceWith(angular.element($interpolate(tag)(options))),function(scope,element,attrs,noinkCtrl){function buildMouseWatcher(element,handlerFn){return function(active){angular.forEach("mouseup,mouseleave".split(","),function(eventType){var fn=active?element.on:element.off;fn.apply(element,[eventType,handlerFn])})}}function localToCanvas(e){var canvas=element[0].getBoundingClientRect();return{x:e.clientX-canvas.left,y:e.clientY-canvas.top}}if(!noinkCtrl)var ripple,watchMouse,parent=element.parent(),makeRipple=$throttle({start:function(){ripple=ripple||$materialEffects.inkRipple(element[0],options),watchMouse=watchMouse||buildMouseWatcher(parent,makeRipple),parent.on("mousedown",makeRipple)},throttle:function(e,done){if(Util.isDisabled(element))done();else switch(e.type){case"mousedown":e.ctrlKey||e.button===RIGHT_BUTTON||(watchMouse(!0),ripple.createAt(options.forceToCenter?null:localToCanvas(e)));break;default:watchMouse(!1),ripple.draw(done)}},end:function(){watchMouse(!1)}})()}}return{restrict:"E",require:"^?noink",compile:compileWithCanvas}}angular.module("material.animations").directive("materialRipple",["$materialEffects","$interpolate","$throttle",MaterialRippleDirective])}(),angular.module("material.components.button",["material.animations","material.services.expectAria"]).directive("materialButton",["ngHrefDirective","$expectAria",MaterialButtonDirective]),angular.module("material.components.card",[]).directive("materialCard",[materialCardDirective]),angular.module("material.components.checkbox",["material.animations","material.services.expectAria"]).directive("materialCheckbox",["inputDirective","$expectAria",materialCheckboxDirective]),angular.module("material.components.content",["material.services.registry"]).directive("materialContent",[materialContentDirective]),angular.module("material.components.dialog",["material.animations","material.services.compiler"]).directive("materialDialog",["$$rAF",MaterialDialogDirective]).factory("$materialDialog",["$timeout","$materialCompiler","$rootElement","$rootScope","$materialEffects","$animate",MaterialDialogService]),angular.module("material.components.form",[]).directive("materialInputGroup",[materialInputGroupDirective]).directive("materialInput",[materialInputDirective]),angular.module("material.components.icon",[]).directive("materialIcon",[materialIconDirective]),angular.module("material.components.list",[]).directive("materialList",[materialListDirective]).directive("materialItem",[materialItemDirective]),angular.module("material.components.radioButton",["material.animations","material.services.expectAria"]).directive("materialRadioGroup",[materialRadioGroupDirective]).directive("materialRadioButton",["$expectAria",materialRadioButtonDirective]),angular.module("material.components.sidenav",["material.services.registry"]).factory("$materialSidenav",["$materialComponentRegistry",materialSidenavService]).directive("materialSidenav",["$timeout",materialSidenavDirective]).controller("$materialSidenavController",["$scope","$element","$attrs","$timeout","$materialSidenav","$materialComponentRegistry",materialSidenavController]),angular.module("material.components.slider",[]).directive("materialSlider",["$window",materialSliderDirective]),angular.module("material.components.tabs",["material.animations","material.services.attrBind","material.services.registry"]).controller("materialTabsController",["$scope","$attrs","$materialComponentRegistry","$timeout",TabsController]).directive("materialTabs",["$compile","$timeout","$materialEffects","$window","$$rAF",TabsDirective]).directive("materialTab",["$attrBind",TabDirective]);var isNodeType=function(node,type){return node.tagName&&(node.hasAttribute(type)||node.hasAttribute("data-"+type)||node.tagName.toLowerCase()===type||node.tagName.toLowerCase()==="data-"+type)},isNgRepeat=function(node){var COMMENT_NODE=8;return node.nodeType==COMMENT_NODE&&node.nodeValue.indexOf("ngRepeat")>-1},isNodeEmpty=function(node){var TEXT_NODE=3,COMMENT_NODE=8;return node.nodeType==COMMENT_NODE||node.nodeType==TEXT_NODE&&!(node.nodeValue||"").trim()};angular.module("material.components.toast",["material.services.compiler"]).directive("materialToast",[QpToastDirective]).factory("$materialToast",["$timeout","$rootScope","$materialCompiler","$rootElement","$animate",QpToastService]),angular.module("material.components.toolbar",["material.components.content"]).directive("materialToolbar",["$$rAF","$sniffer",materialToolbarDirective]),angular.module("material.components.whiteframe",[]),angular.module("material.decorators",[]).config(["$provide",function($provide){function rAFDecorator($$rAF,$rootScope){return $$rAF.debounce=function(cb,invokeApply){1===arguments.length&&(invokeApply=!0);var queueArgs,alreadyQueued,queueCb,context;return function(){queueArgs=arguments,context=this,queueCb=cb,alreadyQueued||(alreadyQueued=!0,$$rAF(function(){invokeApply?$rootScope.$apply(function(){queueCb.apply(context,queueArgs)}):queueCb.apply(context,queueArgs),alreadyQueued=!1}))}},$$rAF}$provide.decorator("$$rAF",["$delegate","$rootScope",rAFDecorator])}]),angular.module("material.services.expectAria",[]).service("$expectAria",["$log",ExpectAriaService]),angular.module("material.services.attrBind",[]).factory("$attrBind",["$parse","$interpolate",MaterialAttrBind]),angular.module("material.services.compiler",[]).service("$materialCompiler",["$q","$http","$injector","$compile","$controller","$templateCache",materialCompilerService]),angular.module("material.services.position",[]).factory("$position",["$document","$window",MaterialPositionService]),angular.module("material.services.registry",[]).factory("$materialComponentRegistry",["$log",materialComponentRegistry]),angular.module("material.services.throttle",[]).factory("$throttle",["$timeout","$q","$log",MaterialThrottleService])}()}).call(this,require("oMfpAn"),"undefined"!=typeof self?self:"undefined"!=typeof window?window:{},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/libs/angular-material.js","/libs");
},{"buffer":5,"oMfpAn":9}]},{},[62])