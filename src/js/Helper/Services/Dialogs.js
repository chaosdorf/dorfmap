...
angular.module('Helper').service('Dialogs', function ($mdDialog, $sce, $templateCache) {
  angular.extend(this, {
    ...
    yesNoDialog: function yesNoDialog(options, okCallback, closeCallback, cancelCallback) {
      var okLabel = 'Ok';
